...
from .color.distance import ciede2000  # single shared CIEDE2000 (re-exported here)
...
# CIEDE2000 now lives in app/color/distance.py (imported above) — kept as a
# module-level name here because calibration.py and gamut_lab.py call it as
# ``spectral_km.ciede2000``. It is the same vectorised implementation that used
# to be defined inline in this module.
